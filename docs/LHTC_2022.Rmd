...
.center[<img src="../data/cisco_drawing.png" width="40%" height="40%"/>]
...
.left[
<img src="../docs/full_array.png" width="70%" height="70%"/>
]
]
---
...
.left[
<div class="flex2">
	<img src="../docs/ice_shanty_cisco_tagging_winter.JPG" width="50%" height="50%"/>
	<img src="../docs/inside_ice_shanty_cisco_tagging_winter.JPG" width="25%" height="25%"/>
</div>
]
]
]
...
.left[
<img src="../docs/cisco_efish_boat_LesCheneaux_cholbrook_20181108.JPG" width="65%" height="65%"/>
]
...
.center[
<img src="../output/gif/bubble_ani.gif" width="50%" height="50%"/>
]
---
class: top, center
...
.pull-left[
<img src="../output/grouped_boxplot_depth.png" width="100%" height="100%"/>
]

.pull-right[
<img src="../output/temperature_boxplot.png" width="100%" height="100%"/>
]
...
- Depth experienced: 0-30 m, median depth 7-11 m
  - less than 20 m November to April
  - some greater than 20 m May to October
  - water depth at receiver: 0-60 m
...
<center>
<img src="../docs/cisco_sampling_20171114_180542.jpg", width="18%" height="18%"/>
</center>
...
.center[<img src="../data/cisco_drawing.png" width="30%" height="30%"/>]
...
- 2021 GLFC Pilot Project ~$20K
  ...
  - 26 V5D-180 kHz tags (12.7 mm L x 5.7 mm D, 0.64 g in air)
]
...
- Post-tagging- hatchery until October 9, 2021
- Fish released in Saginaw Bay- Evening of October 9, 2021
- "Predation" tags- detect and count time since eaten by predator
- Tags random delay between transmissions-  70-110 seconds, battery life ~139 days

## Receiver deployment
- 60 Vemco VR2W-180 receivers (September 2021)
- Water depth- 0- ~15 m
...
.center[<img src="../output/cum_dtc_pred.png" width="75%" height="75%"/>]
...
# Conclusions
.left[
- Extensive movements, rapid dispersal
- 7 known predation events (out of 26 fish)
- Most left array after 5-6 days
